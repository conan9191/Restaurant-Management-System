...
$(function(){
	 ...
	 $('#orderSeatTab').click(function(){
		 if(orderSeatTimes==0){
			 $('#select-time').attr("class","model show");   
			 orderSeatTimes=orderSeatTimes+1;
	 		}
	 ...
	 $('#showDetail-button').click(function(){ 
		 if(show<0){
			 $("#booking-details").css("transition","margin-left 0.5s").css("margin-left","-195px");  	 
			 $(".seatCharts-container").css("transition","margin-left 0.5s").css("margin-left","0px");  	 
		 }
		
		if(show>0){
			 $("#booking-details").css("transition","margin-left 0.5s").css("margin-left","0px"); 	
			 $(".seatCharts-container").css("transition","margin-left 0.5s").css("margin-left","150px"); 
		 }
		 show=show*-1; 
     }); 
